...
* Fault diagnostics and audio visual integrated conference room installations. Interpreta:on of CAD plans.
...
and truss - CAD plans, description of the type and weight of the equipment being used, scissor lift licenses.
...
client signatures for invoices through the use of software programs including Triumph, Global Suite, Microsoft Outlook, Excel.
