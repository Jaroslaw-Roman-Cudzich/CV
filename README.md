...
| Project                                                                                                                         | Description                                                                                          | Technology Stack                                          | Test Driven Development                   |
|---------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|-------------------------------------------------------|-------------------------------------------|        
...
##### Problem solving and fault diagnostics - Analytical thinker
...
As a manager and as a senior technician, I took pride in leading and learning from my employees and colleagues.  My constructive feedback and clear guidelines for the tasks at hand motivated the team to work to their full potential.  The pairing sessions and projects created at Makers Academy have allowed my communication skills to shine through into the development of sophisticated full stack programs.  
